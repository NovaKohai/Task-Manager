...
name: internal-comms
description: |
  Use when a Head of People Ops, BizOps lead, or Internal Communications owner
  needs to draft and sequence an internal-only change-management communication —
  re-org, tool rollout, policy/benefit change, leadership transition, layoff,
  acquisition, or product launch — for employees (not customers).
  Triggers: "all-hands", "town-hall", "change comms", "internal newsletter",
  "rollout comms", "policy change", "re-org", "internal FAQ", "manager talking
  points", "Prosci ADKAR", "Kotter 8-step", "layoff", "RIF", "internal memo".
  Pairs Prosci ADKAR and Kotter's 8-step with stdlib-only Python tools to
  produce: sequenced touchpoint calendar, Kotter-compliant announcement,
  audience-segmented FAQ, manager cascade talking points. Industry-tuned via
  --profile {tech-startup, scaleup, enterprise, public-company, non-profit}.
  Distinct from marketing-skill/* (external), c-level-advisor/internal-narrative
  (strategic, not tactical), and c-level-advisor/change-management (strategy,
  not comms).
version: 2.8.0
