...
### PASS
- Scale uses a small set of intentional sizes with clear jumps
- Type hierarchy combines size, weight, line-height, and color
- Body text remains readable across contexts
...
- `em` sizing compounds unpredictably
