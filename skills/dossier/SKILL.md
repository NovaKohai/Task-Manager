---
name: dossier
description: "Decision-grade entity research — produces a hypothesis-tested dossier on a company, person, nonprofit, or government org. Forcing intake makes user state hypothesis upfront so the dossier tests rather than confirms it. Output: editable .docx with verdict, identity facts, 12-month timeline, network signals, reputation signals, red flags, 3-5 conversation hooks tied to findings, and source-provenance audit log. Uses WebSearch + WebFetch + free APIs (SEC EDGAR, GitHub, ProPublica); optional BYOK MCPs (LinkedIn, Crunchbase, Apollo, Pitchbook, SimilarWeb) enhance coverage. Triggers: 'research [company]', 'dossier on [person/company]', 'background check on [entity]', 'prep me for a meeting with [person/company]', 'due diligence on [company]', 'what should I know about [entity]', 'research [person] before I [meet/hire/invest]', 'competitor research on [company]', 'investor diligence [company]', 'interview prep for [company]'. Honors sensitivity exclusions for journalism + personal-vetting.\""
license: MIT
metadata:
