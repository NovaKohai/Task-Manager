...
description: |
  Use when running an annual SaaS audit, category-level spend review, or
  supplier base rationalization. Triggers: "spend audit", "SaaS audit",
  "spend categorization", "supplier rationalization", "supplier consolidation",
  "purchasing cycle", "procurement review", "category strategy", "duplicate
  SaaS", "renewal cluster". Ships 3 stdlib-only Python tools (UNSPSC-aligned
  spend categorizer with Pareto breakdown and industry profiles, purchasing-cycle
  analyzer surfacing bottlenecks per Goldratt's Theory of Constraints,
  supplier-consolidation planner refusing single-source recommendations for
  tier-1 without a break-glass plan), 3 reference docs citing 7+ authoritative
  sources (A.T. Kearney / Hackett / Spend Matters / UNSPSC / Productiv / Vendr /
  Tropic / IACCM / ISM / BCG), and a 20-minute spend-intake template. Distinct
  from sibling vendor-management (performance scoring), finance/financial-analysis
  (close + report), and c-level-advisor/general-counsel-advisor (contract law).
version: 2.8.0
