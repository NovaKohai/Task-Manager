...
description: |
  Use when reviewing, scoring, or auditing third-party SaaS/vendor relationships
  — running vendor scorecard, tracking SLA compliance, classifying third-party
  risk, preparing tier-1 review, or auditing SaaS portfolio. Triggers:
  "vendor SLA", "vendor scorecard", "third-party risk", "TPRM", "vendor
  review", "SaaS audit", "supplier performance", "vendor health check",
  "renewal review". Forks context so large vendor catalogs and SLA logs don't
  pollute parent thread. Ships 3 stdlib-only Python tools (vendor scorer, SLA
  tracker with credit-claim flags, risk classifier across 4 vectors), 3 reference
  docs citing 7+ sources (Gartner / Shared Assessments / NIST / ISO 27036 /
  breach post-mortems), and a 5-vendor catalog template. Distinct from
  c-level-advisor/general-counsel-advisor (contract law, not operations),
  business-growth/contract-and-proposal-writer (outbound, not inbound scoring),
  and sibling procurement-optimizer (spend, not vendor performance).
context: fork
version: 2.8.0
